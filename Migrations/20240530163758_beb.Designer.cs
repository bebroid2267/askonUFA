...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("askonUFA.Database.TreeItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("askonUFA.Database.Attributes", b =>
                {
                    b.HasBaseType("askonUFA.Database.TreeItem");
            ...
            modelBuilder.Entity("askonUFA.Database.TreeItem", b =>
                {
                    b.HasOne("askonUFA.Database.Objects", null)
                        .WithMany("ChildTreeItems")
                        .HasForeignKey("ObjectsId");

                    b.HasOne("askonUFA.Database.Objects", null)
                        .WithMany("CombinedChildren")
                        .HasForeignKey("ObjectsId1");
                });
            ...
            modelBuilder.Entity("askonUFA.Database.Objects", b =>
                {
                    b.HasOne("askonUFA.Database.TreeItem", null)
                        .WithOne()
                        .HasForeignKey("askonUFA.Database.Objects", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("askonUFA.Database.Objects", b =>
                {
                    ...
                    b.Navigation("ChildTreeItems");

                    b.Navigation("CombinedChildren");
